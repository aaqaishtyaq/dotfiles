...
# Anonymous function to avoid leakage of variables.
light_saber() {
    #PowerLine plugin
    ...
    typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k*|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|gcloud|aws|gcs|kubent|_*'
    typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_DEFAULT_NAMESPACE=true
    typeset -g POWERLEVEL9K_ASDF_FOREGROUND=$COLOR_BLACK
    typeset -g POWERLEVEL9K_ASDF_SOURCES=(shell local global)
    typeset -g POWERLEVEL9K_AWS{,_ASSUME_ROLE}_SHOW_ON_COMMAND='k*|aws|awless|terraform|k|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|a|aw|aws-prf|kx|_*'
    typeset -g POWERLEVEL9K_GCLOUD_SHOW_ON_COMMAND='k*|gcloud|gcs|k|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|kx|_*'
